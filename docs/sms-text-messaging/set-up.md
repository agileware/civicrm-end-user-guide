...
You now have all of the information needed to configure SMS in CiviCRM. After installing the [Clickatell extension](https://civicrm.org/extensions/clickatell-sms-provider) in CiviCRM, go to: **Administer** > **System
